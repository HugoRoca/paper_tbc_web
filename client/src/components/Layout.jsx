...
const Layout = ({ children }) => {
  ...
  const isMedico = user?.role?.nombre === 'Médico'
  ...
  const menuItems = [
    ...
    },
    {
      ...
      items: [
        ...
        { icon: UserCheck, label: 'Derivaciones/Transferencias', path: '/derivaciones-transferencias' },
      ],
    },
    {
      title: 'Alertas',
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between p-4 border-b border-gray-200">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-gray-900">Sistema TBC</span>
            </div>
            <button
              onClick={() => setSidebarOpen(false)}
